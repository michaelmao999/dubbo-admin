 ...
 */
public class SimpleDubboMonitorService implements MonitorService {

    private static final Logger logger = LoggerFactory.getLogger(SimpleDubboMonitorService.class);
    ...
    public SimpleDubboMonitorService() {
    ...
    public void close() {
        try {
            running = false;
            queue.offer(new URL(POISON_PROTOCOL, "127.0.0.1", 0));
        } catch (Throwable t) {
