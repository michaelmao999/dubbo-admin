...
public class ProvidersPageHandler implements PageHandler {
    ...
    public Page handle(URL url) {
        ...
        if (service != null && service.length() > 0) {
            ...
            List<org.apache.dubbo.common.URL> providers = RegistryContainer.getInstance().getProvidersByService(service);
            if (providers != null && providers.size() > 0) {
                for (org.apache.dubbo.common.URL u : providers) {
            ...
            List<List<String>> rows = new ArrayList<List<String>>();
            List<org.apache.dubbo.common.URL> providers = RegistryContainer.getInstance().getProvidersByApplication(application);
            if (providers != null && providers.size() > 0) {
                for (org.apache.dubbo.common.URL u : providers) {
                    List<String> row = new ArrayList<String>();
                    String s = u.toFullString();
